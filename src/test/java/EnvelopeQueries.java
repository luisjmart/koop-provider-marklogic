...
public class EnvelopeQueries extends AbstractFeatureServiceTest{
	...
	@Test
    public void testEnvelopeIntersects7() {
	...
	//testEnvelopeAirportIntersects
	@Test
    public void testEnvelopeIntersects8() {
	...
	//testEnvelopeShoppingCentreIntersects
	@Test
    public void testEnvelopeIntersects9() {
	...
	//testEnvelopeWildlifeRefugeIntersects
	@Test
    public void testEnvelopeIntersects10() {
        ...
        RestAssured
            ...
            .then()
                ...
                .statusCode(200)
                .body("features.size()", is(1))
                .body("features.attributes.name", hasItems("Flyway"))
            ; 
	}
    ...
    @Test
    public void testEnvelopeContains4() {
		...
		@Test
	    public void testEnvelopeContains5() {
